...
namespace AxzonTempSensor
{
    public partial class MainForm : Form
    {
        ...
        private void ConnectReader()
        {
            ...
            if (ThingMagicM6eRadioButton.Checked)
            {
                reader = new M6e();
            }
            else
        ...
        private void ThingMagicM6eRadioButton_CheckedChanged(object sender, EventArgs e)
        {
            if (ThingMagicM6eRadioButton.Checked)
            {
        ...
        private void ZebraFX9600RadioButton_CheckedChanged(object sender, EventArgs e)
        {
            if (ThingMagicM6eRadioButton.Checked)
            {
                ComPortRadioButton.Checked = true;
